...
-- Create policies
CREATE POLICY "Enable all for authenticated users" ON public.student_fees FOR ALL USING (true);
CREATE POLICY "Enable all for authenticated users" ON public.fee_templates FOR ALL USING (true);
